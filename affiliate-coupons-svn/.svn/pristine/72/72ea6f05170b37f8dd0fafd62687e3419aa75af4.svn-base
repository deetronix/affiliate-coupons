...
function affcoups_register_coupon_meta_boxes( $meta_boxes ) {
    ...
    $fields = array(
        array(
            ...
            'id'          => AFFILIATE_COUPONS_PREFIX . 'coupon_vendor',
            'type'        => 'post',
        ...
        array(
            ...
            'id'               => AFFILIATE_COUPONS_PREFIX . 'coupon_image',
        ...
        array(
            ...
            'id'         => AFFILIATE_COUPONS_PREFIX . 'coupon_valid_until',
            'type'       => 'date',
            'timestamp'  => true,
            // jQuery date picker options. See here http://api.jqueryui.com/datepicker
            'js_options' => array(
    ...
    $meta_boxes[] = array(
        'id'         => AFFILIATE_COUPONS_PREFIX . 'coupon_details',
        ...
        'validation' => array(
            'rules'    => array(
                AFFILIATE_COUPONS_PREFIX . 'coupon_vendor' => array(
                    'required'  => true
                ),
            ),
            'messages' => array(
